...
public class Computer {
	...
	int ssd = 1024; // 기본적으로 접근제한자를 선언하지 않을 경우 자동으로 default로 지정됨
	int ram = 64;
	float cpu = 4.8f;
	String color = "white";
	...
	// 메서드의 구성
	// 접근제한자 반환형 메서드명(파라미터, 인자, 매개변수, 아규먼츠){
	//	메서드의 실행 영역
	//}

	// 접근제한자
	// 1) public : 같은 프로젝트 내의 모든 클래스에서 사용할 수 있도록 허가
	// 2) private : 현재 클래스 내에서만 사용할 수 있도록 제한 / 보안 쪽으로 유용
	// 3) protected : 상속(부모자식)관계의 객체들에게만 사용을 허가 
